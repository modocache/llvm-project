; Verifies that restart trigger that is used by legacy coroutine passes forces
; the legacy pass manager to restart IPO pipelines, thereby causing the same
; coroutine to be looked at by CoroSplit pass twice.
; REQUIRES: asserts
